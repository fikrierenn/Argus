...
description: BkmArgus kod yazarken/düzenlerken otomatik danış. Yaygın hataları yazım sırasında önle (handoff taraması son doğrulama olsun). "checklist", "kontrol", "kalite kontrol" komutlarıyla çağrılır.
allowed-tools: Read, Grep, Glob
user-invocable: true
model: inherit
---

# BkmArgus Code Quality Checklist
...
// BkmArgus tercih: SP içinde BEGIN TRANSACTION (sp_ReceivingPost pattern'i)
```
