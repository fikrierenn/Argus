...
- SP/şema ise: `sql/db_objects*.sql` / `schema_M*.sql`'de mevcut tanımı oku.
- Migration kaydı: `src/BkmArgus.Cli/Program.cs` migrate listesini oku (yeni schema buraya eklenir).
