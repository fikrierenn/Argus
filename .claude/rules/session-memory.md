...
|---|---|---|---|
| **Kimlik (Identity)** | `CLAUDE.md` | Proje tanımı, tech stack, kurallar indeksi, hızlı referanslar. | "Dapper, net10.0, Razor Pages, SP-first, 8 şema." |
...
2.  **`/clear` Ne Zaman Tetiklenir?**
    *   Üzerinde çalışılan modül veya ana görev tamamen değiştiğinde (örn: ETL işinden AI worker'a geçiş).
