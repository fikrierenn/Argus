...
Bu dosya, BkmArgus platformunun kullanıcı arayüzü (UI) dili ve yazılım dili standartlarını tanımlar. Kullanıcının gördüğü her şeyin tamamen Türkçe olması projenin en temel kurallarından biridir.

---

## 0. Karar (2026-05-28): Tek Dil — Türkçe

BkmArgus arayüzü **tamamen ve sadece Türkçe** olarak çalışır. İngilizce arayüz desteği bulunmaz:
...
| **Veritabanı Şeması** | **İNGİLİZCE PASCALCASE** | Tablo ve kolon isimleri (`DailyProductRisk`, `LocationId`, `RiskScore`). SP **parametreleri Turkce** (`@MekanId`). |
...
| **Durum Sabitleri (Enums/Codes)** | **İNGİLİZCE SABİT** | `DofStatus.Acik`, `RiskType.StokYok`, `Roles.Admin`. |
...
| **Post / Approve** | **Onayla** | Denetim finalize / DÖF kapatma butonları |
