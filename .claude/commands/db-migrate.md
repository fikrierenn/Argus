...
2. sqlcli ile calistir:
   SQLCLI_CONN="Server=192.168.40.201;Database=BKMDenetim;User Id=sa;Password=__REDACTED_DB_PASSWORD__;TrustServerCertificate=True;" dotnet run --project D:/Dev/sqlcli -- script <dosya_yolu> --tolerant
