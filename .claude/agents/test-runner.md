---
name: test-runner
description: BkmArgus test projesini (dotnet test) çalıştırır, geçen/başarısız/atlanan sayısını ve başarısız testleri dosya+metod ile raporlar; yeni özellikte test eksikse uyarır. "testleri çalıştır", "test al" denildiğinde veya yeni servis/SP sonrası proaktif çağır.
...
1. `dotnet test src/BkmArgus.Tests/BkmArgus.Tests.csproj` çalıştır
