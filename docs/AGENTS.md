...
- AI: LM Rules (deterministik) -> Semantik Hafiza (Ollama embedding) -> LLM (Gemini/Codex/Ollama)
...
3. Ortak: SemanticMemoryService (DOF + denetim bulgulari), LlmService (Gemini->Codex->Ollama)
