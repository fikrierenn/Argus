...
**Skill'ler** (`.claude/skills/`, 17): `bkmargus-sp-first` · `bkmargus-ai-worker` · `bkmargus-tespit` · `cati-degerlendirme` · `surum-disiplini` · `sql-migration-writer` · `bkm-db-explorer` · `impl-spec` · `plan-tracker` · `session-handoff` · `code-quality-checklist` · `feature-completeness-audit` · `screen-ux-standard` · `llm-council` · `yetenek-uret`
